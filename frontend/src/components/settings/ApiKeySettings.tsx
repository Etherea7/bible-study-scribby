    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <motion.div
          ...
          className="relative bg-[var(--bg-elevated)] rounded-xl shadow-xl max-w-lg w-full mx-4 max-h-[90vh] overflow-hidden"
        >
          {/* Header */}
          ...
          {/* Footer */}
          <div className="flex items-center justify-between p-4 border-t border-[var(--border-color)] bg-[var(--bg-surface)]">
            <button
